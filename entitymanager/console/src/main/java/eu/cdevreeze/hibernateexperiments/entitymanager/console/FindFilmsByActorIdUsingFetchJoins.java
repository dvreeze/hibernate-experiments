 ...
 * It uses {@link ConcreteFilmServiceUsingFetchJoinFactory}.
 *
 * @author Chris de Vreeze
 */
public class FindFilmsByActorIdUsingFetchJoins {
    ...
    static void main(String... args) {
        ...
        try (EntityManagerFactory emf = EntityManagerFactories.createEntityManagerFactory("pagila")) {
            FilmService filmService = ConcreteFilmServiceUsingFetchJoinFactory.create(emf);
