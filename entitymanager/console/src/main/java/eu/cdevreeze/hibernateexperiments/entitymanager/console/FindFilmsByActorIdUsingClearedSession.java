 ...
 * It uses {@link ConcreteFilmServiceUsingClearedSessionFactory}.
 *
 * @author Chris de Vreeze
 */
public class FindFilmsByActorIdUsingClearedSession {
    ...
    static void main(String... args) {
        ...
        try (EntityManagerFactory emf = EntityManagerFactories.createEntityManagerFactory("pagila")) {
            FilmService filmService = ConcreteFilmServiceUsingClearedSessionFactory.create(emf);
