...
/**
 * Unit test of {@link NaiveFilmService}, using an embedded H2 database.
 *
 * @author Chris de Vreeze
 */
class NaiveFilmServiceH2Test extends AbstractFilmServiceH2Test {

    @Override
    protected FilmService filmService(EntityManagerFactory emf) {
        return new NaiveFilmService(emf);
    }
}
