...
module eu.cdevreeze.hibernateexperiments.entitymanager.service {
    ...
    exports eu.cdevreeze.hibernateexperiments.entitymanager.service.factory;

    // Needed for opening up the JPA entities to Hibernate for reflection
    opens eu.cdevreeze.hibernateexperiments.entitymanager.entity to org.hibernate.orm.core;
}