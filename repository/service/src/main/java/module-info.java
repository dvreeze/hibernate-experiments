 ...
 */
module eu.cdevreeze.hibernateexperiments.repository.service {
    requires com.google.common;
    requires org.jspecify;
    requires jakarta.annotation;
    requires jakarta.persistence;
    requires jakarta.data;
    requires transitive eu.cdevreeze.hibernateexperiments.repository.model;
    ...
    exports eu.cdevreeze.hibernateexperiments.repository.bootstrap;
    exports eu.cdevreeze.hibernateexperiments.repository.service;
    exports eu.cdevreeze.hibernateexperiments.repository.service.factory;

    // Needed for opening up the JPA entities to Hibernate for reflection
    opens eu.cdevreeze.hibernateexperiments.repository.entity to org.hibernate.orm.core;
}