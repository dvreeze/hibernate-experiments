 ...
 */
module eu.cdevreeze.hibernateexperiments.emcriteria.service {
    requires com.google.common;
    requires org.jspecify;
    requires jakarta.annotation;
    requires jakarta.persistence;
    requires transitive eu.cdevreeze.hibernateexperiments.emcriteria.model;
    ...
    exports eu.cdevreeze.hibernateexperiments.emcriteria.bootstrap;
    exports eu.cdevreeze.hibernateexperiments.emcriteria.service;
    exports eu.cdevreeze.hibernateexperiments.emcriteria.service.factory;

    // Needed for opening up the JPA entities to Hibernate for reflection
    opens eu.cdevreeze.hibernateexperiments.emcriteria.entity to org.hibernate.orm.core;
}