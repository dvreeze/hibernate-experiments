 ...
 * It uses {@link ConcreteFilmServiceUsingMultipleLoadGraphsFactory}.
 *
 * @author Chris de Vreeze
 */
public class FindFilmsByActorIdUsingMultipleLoadGraphs {
    ...
    static void main(String... args) {
        ...
        try (EntityManagerFactory emf = EntityManagerFactories.createEntityManagerFactory("pagila")) {
            FilmService filmService = ConcreteFilmServiceUsingMultipleLoadGraphsFactory.create(emf);
