...
Put differently, per-query fetching tends to take away "magic" w.r.t. what SQL queries are generated by Hibernate.
By being explicit about per-query fetching, we tend to regain control over the generated SQL.
...
This approach also tends to take away "Hibernate magic" related to which SQL queries are generated.
Besides, it takes away "Hibernate magic" related to hidden state of returned entities, since immutable
DTOs are returned instead of entities.
