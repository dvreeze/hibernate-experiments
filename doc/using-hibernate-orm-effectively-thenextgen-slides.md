...
We fix these problems (`LazyInitializationException` and N + 1 select issue) by specifying *what data to fetch at the query level*. This should *not be decided (globally) at the entity level*!
