 ...
 */
module eu.cdevreeze.hibernateexperiments.emrepository.service {
    requires com.google.common;
    requires org.jspecify;
    requires jakarta.annotation;
    requires jakarta.persistence;
    requires jakarta.data;
    requires jakarta.data.stateful;
    requires transitive eu.cdevreeze.hibernateexperiments.emrepository.model;
    ...
    exports eu.cdevreeze.hibernateexperiments.emrepository.service.factory;

    // Needed for opening up the JPA entities to Hibernate for reflection
    opens eu.cdevreeze.hibernateexperiments.emrepository.entity to org.hibernate.orm.core;
}